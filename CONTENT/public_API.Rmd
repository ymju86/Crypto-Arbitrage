...
I've written a [set of functions](https://github.com/ymju86/Cryp-To/blob/master/FUNCTIONS/Public_Market_Functions.R) allowing to get the price of many different currencies for the 5 main exchanges. You can easily use these functions. For instance, type the code below in R:
...
This was easily done using an infinite loop that called the functions described above. The exact script used for this work is available [here](https://github.com/ymju86/Crypto-Arbitrage/blob/master/FUNCTIONS/Run_API_public_market_harvest.R). 800,000 data points were recovered.
...
```{r, warning=FALSE, message=FALSE, eval=FALSE}
 # Load the data
load(url("https://raw.githubusercontent.com/ymju86/Crypto-Arbitrage/master/DATA/public_ticker_harvest.Rdata"))  
...
<br>
<center>
<a class="btn btn-primary" href="https://ymju86.github.io/Crypto-Arbitrage/CONTENT/differences.html">Quantifying differences</a>
</center>
<br><br>
