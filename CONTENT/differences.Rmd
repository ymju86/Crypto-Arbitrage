...
#Data
***
Prices of `5 cryto currencies` have been harvested for `2 weeks` on `5 different exchanges` every `few seconds` as described [here](https://ymju86.github.io/Crypto-Arbitrage/CONTENT/public_API.html). About `800,000 data points` are available, allowing to compare prices between exchanges at a high resolution.
...
<br>
<center>
<a class="btn btn-primary" href="https://ymju86.github.io/Crypto-Arbitrage/CONTENT/public_API.html">< How data was harvested</a>
